    ...
    <div className="h-screen bg-gray-800 pt-20">
      <div className="mx-auto p-8 lg:w-1/2 xl:w-1/3">
        <div className="rounded-t-lg bg-white p-8">
          <p className="text-center text-sm font-light text-gray-400">Sign up with</p>
          <div>
        ...
        <div className="rounded-b-lg bg-gray-100 py-12 px-4 lg:px-24">
          <p className="text-center text-sm font-light text-gray-500"> Or sign up with credentials </p>
          <form className="mt-6">
            ...
            <p className="mt-4 text-xs font-light italic text-gray-500">
              Password strength: <span className="text-green-400 font-bold">strong</span>
            </p>
            <div className="mt-4 flex items-center text-gray-500">
              {" "}
              <input type="checkbox" id="remember" name="remember" className="mr-2" /> I agree with the{" "}
