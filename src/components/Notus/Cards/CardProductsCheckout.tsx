    ...
    <>
      <div className="relative mb-6 flex w-full min-w-0 flex-col break-words rounded-lg bg-white shadow-lg">
        <div className="flex-auto px-4 py-5">
          ...
          {discount && (
            <>
              <hr className="bg-blueGray-300 mb-4 ml-0 mt-6" />
          ...
          {details.map((prop: any, key: any) => (
            <div key={key}>
              <hr className="bg-blueGray-300 mb-2 ml-0 mt-4" />
              {prop.map((propDetails: any, propKey: any) => (
                <div key={propKey} className="flex justify-between">
                  <h6 className="text-blueGray-700 mb-2 mt-0 leading-normal">
                    {propDetails.text}
                  </h6>
                  <h6 className="mb-2 mt-0 leading-normal">
                    {propDetails.info}
                  </h6>
                </div>
              ))}
